...
// The SForm is the transformation matrix of the affine transformation used to
...
// This sets up the pixel transformations once, rather than doing them over
// and over.  However, its not clear to me that this is actually more efficient.
// Beware that this routine must be amended if the SForms are not all diagonal
// or antidiagonal.
